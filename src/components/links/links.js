...
let Links = (props) => {
    return (
          <ul className={props.Class}>
            <Link Href={"mailto:arunet008@gmail.com?subject=Job%20oppurtunity&body=Hi%20Arun,%0D%0A%0D%0AI saw ur portfolio and would like to discuss about an oppurtunity with you.%0D%0A%0D%0Athanks and regards,%0D%0A"} Source={Icons.mail}>Email</Link>
            <Link Href={"https://github.com/Et-008"} Source={Icons.github}>Github</Link>
            <Link Href={"https://twitter.com/et_arun?s=09"} Source={Icons.twitter}>Twitter</Link>
            <Link Href={Document} Source={Icons.document}>Resume</Link>
